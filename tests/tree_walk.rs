...
mod expressions {
    rlox::lox_tests!(
        ...
        [
            evaluate,
            #[ignore = "chapter-specific: AST printer mode"]
            parse,
        ]
    );
}
...
mod function {
    rlox::lox_tests!(
        ...
        [
            ...
            empty_body,
            extra_arguments,
            #[ignore = "behavior: no forward-reference error in tree-walk"]
...
mod operator {
    rlox::lox_tests!(
        ...
        [
            ...
            #[ignore = "unimplemented: classes"]
            equals_method,
            #[ignore = "behavior: no operand type-check for comparisons"]
            greater_nonnum_num,
            #[ignore = "behavior: no operand type-check for comparisons"]
            greater_num_nonnum,
            #[ignore = "behavior: no operand type-check for comparisons"]
...
mod variable {
    rlox::lox_tests!(
        "variable",
        [
            #[ignore = "behavior: resolver doesn't detect parameter collision"]
            collide_with_parameter,
            #[ignore = "behavior: resolver doesn't detect duplicate locals"]
            duplicate_local,
            #[ignore = "behavior: resolver doesn't detect duplicate parameters"]
            duplicate_parameter,
            early_bound,
            in_middle_of_block,
            in_nested_block,
            ...
            #[ignore = "behavior: resolver doesn't detect self-referencing initializer"]
